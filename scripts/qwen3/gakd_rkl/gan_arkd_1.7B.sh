...
CKPT_NAME="Qwen3-1.7B_init"
CKPT="${BASE_PATH}/checkpoints/${CKPT_NAME}"

DISCRIM="MLPEmbeddingLLMDiscriminator" #type: SimpleMLPDiscriminator/MLPEmbeddingLLMDiscriminator/WGANLLMDiscriminator/others
...
SAVE_PATH="${BASE_PATH}/results/gan-rkld/${CKPT_NAME}_lr_${LR}"
# seed
SEED=42
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/finetune_gan_rkld.py ${OPTS} $@"
