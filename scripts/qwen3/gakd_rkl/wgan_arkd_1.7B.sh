...
DISCRIM="WGANLLMDiscriminator" #type: SimpleMLPDiscriminator/MLPEmbeddingLLMDiscriminator/WGANLLMDiscriminator/others
...
SAVE_PATH="${BASE_PATH}/results/wgan-rkld/${CKPT_NAME}_lr_${LR}"
# seed
SEED=42
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/finetune_wgan_rkld.py ${OPTS} $@"
